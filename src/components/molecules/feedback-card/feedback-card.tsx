...
export function FeedbackCard({ feedback, className }: FeedbackCardProps) {
  return (
    <div
      className={cn(
        "group relative flex h-full flex-col border border-border/50 bg-background p-8 transition-all duration-500 hover:border-foreground/50 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]",
        className
      )}
    >
      {/* Comment - Featured */}

...
const headingVariants = cva("font-semibold tracking-tight font-light", {
  variants: {
    variant: {
      display: "text-5xl md:text-6xl lg:text-7xl  leading-none tracking-tight",
      ...
      h5: "text-lg md:text-xl lg:text-2xl  leading-normal tracking-tight",
      h6: "text-base md:text-lg lg:text-xl  leading-normal tracking-tight",
    },
  },
  defaultVariants: {
    variant: "h1",
